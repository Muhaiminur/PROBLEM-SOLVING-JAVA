...
The integers i and j must appear in the output in the same order in which they appeared in the input and should be followed by the maximum cycle length 
(on the same line). 
Sample Input
1 10
100 200
...
public class cse111Lab10task5{
  public static void main(String[]args)throws NumberFormatException, IOException{// entry point from OS{
    Scanner abir=new Scanner(System.in);
    cse111Lab10task5main myWork = new cse111Lab10task5main(); // Construct the bootloader
